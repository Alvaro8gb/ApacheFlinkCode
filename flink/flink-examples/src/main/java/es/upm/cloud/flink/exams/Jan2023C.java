...
public class Jan2023C {
    ...
    public static class MyMap implements MapFunction<String, Tuple3<Long, Long, Double>> {
        ...
        public Tuple3<Long, Long, Double> map(String in) throws Exception {
            ...
            return new Tuple3(Long.parseLong(fieldArray[0]), Long.parseLong(fieldArray[1]), Double.parseDouble(fieldArray[2]));
    ...
    public static void main(String[] args) throws Exception {
        ...
        KeyedStream<Tuple3<Long, Long, Double>, Long> keyedStream = mapOut
                .keyBy(new KeySelector<Tuple3<Long, Long, Double>, Long>() {
                    @Override
                    public Long getKey(Tuple3<Long, Long, Double> e) throws Exception {
                        return e.f1;
                    }
                });

        SingleOutputStreamOperator<Tuple3<Long, Long, Double>> output = keyedStream
